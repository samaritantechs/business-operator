...
export function richBook() {
  ...
  t.products.push(
    { id: 'P1', vendor_id: 'V1', legacy_id: 'P001', name: 'Samsung Galaxy A05', category: 'Phones', brand: 'Samsung', model: 'A05', price: 350000, cost_price: 300000, stock: 3, is_serialized: true, supplier: 'Watu', reorder_point: 2, active: true, image1_url: null, image2_url: null, listing_type: 'Sale', price_unit: '', location: 'Sinza', created_at: '2026-08-01T07:00:00.000Z' },
    { id: 'P2', vendor_id: 'V1', legacy_id: 'P002', name: 'Tecno Spark 20', category: 'Phones', brand: 'Tecno', model: 'Spark 20', price: 280000, cost_price: 250000, stock: 2, is_serialized: true, supplier: '', reorder_point: 2, active: true, listing_type: 'Sale', price_unit: '', location: '', created_at: '2026-08-01T07:00:00.000Z' },
    { id: 'P3', vendor_id: 'V1', legacy_id: 'P003', name: 'Phone Cover', category: 'Accessories', brand: '', model: '', price: 5000, cost_price: 3000, stock: 40, is_serialized: false, supplier: '', reorder_point: 10, active: true, image1_url: 'https://drive.google.com/thumbnail?id=cov&sz=w400', listing_type: 'Sale', price_unit: '', location: '', created_at: '2026-08-01T07:00:00.000Z' },
  ...
  t.sales.push(
    { id: 'S1', legacy_id: 'SALE-0001', group_id: 'G1', vendor_id: 'V1', branch_id: 'B1', seller_id: 'SEL1', seller_name: 'Juma Seller', customer_name: 'Neema Mushi', customer_phone: '0712000111', product_id: 'P1', product_name: 'Samsung Galaxy A05', brand: 'Samsung', model: 'A05', unit_id: 'U4', imei: '350000000000004', qty: 1, list_price: 350000, discount: 10000, price: 340000, total: 340000, unit_cost: 290000, payment_method: 'Credit', financing_partner_id: 'FP1', partner_paid: false, status: 'completed', sold_at: T(9) },
    { id: 'S2', legacy_id: 'SALE-0002', group_id: 'G2', vendor_id: 'V1', branch_id: 'B1', seller_id: 'SEL1', seller_name: 'Juma Seller', customer_name: 'Neema Mushi', customer_phone: '0712000111', unit_cost: 3000, product_id: 'P3', product_name: 'Phone Cover', qty: 2, list_price: 5000, discount: 0, price: 5000, total: 10000, payment_method: 'Cash', status: 'completed', sold_at: T(10) },
    { id: 'S3', legacy_id: 'SALE-0003', group_id: 'G3', vendor_id: 'V1', branch_id: 'B2', seller_id: 'SEL2', seller_name: 'Asha Seller', unit_cost: 3000, product_id: 'P3', product_name: 'Phone Cover', qty: 1, list_price: 5000, discount: 0, price: 5000, total: 5000, payment_method: 'Lipa Number', status: 'completed', sold_at: T(11) },
