...
import * as pending from './bo/pending.js';
import * as billing from './bo/billing.js';
...
const MODULES = { products, sales, lendings, cash, dashboard, users, vendors, reports, emails, hints, settings, stockops, boot, releases, purchasing, pending, billing };
export const FN = {};
